...
export TG_BOT_TOKEN="1622540236:AAG2TYXMpiuQFg6iFJw9TfAcA_Gq8u4A4xc"
## 下方填写 @getuseridbot 中获取到的纯数字ID
export TG_USER_ID="705500039"
## Telegram 代理IP（选填）
...
## 12. 更新女装盲盒脚本，增加推送，1月女装盲盒变量，目前有豆 
...
## 14. 愤怒的锦鲤助力
export kois="wuyaya"
export kois="syysnowwhite"
export kois="jd_5a6a9e4f67563"
export kois="jd_5355a1aeb5cae"
export kois="satanwang1470"
export kois="jd_44183af9831d2"
export kois="jd_PymEbxkRnmtm"
export kois="suzm"
export kois="jd_svgYcvzwahyn"

## 15. 整点，半点京豆雨更新为甘露殿原版
export jd_redrain_half_url="https://gitee.com/msewb/update/raw/master/m_redrain_half_523420221612.json"

## 16.许愿池抽奖机任务
export wish_appIdArrList="1GFRRyqo@1GVJWyqg@1GVFUx6g@1E1xZy6s@1FFVQyqw"                                   
export wish_appNameArrList="过新潮年@虎娃迎福@年味@PLUS生活特权@1111点心动" 

#2022-1-11 超级直播间盲盒抽京豆任务url 脚本jd_mhtask
export jd_mhurlList="https://anmp.jd.com/babelDiy/Zeus/4ZRoEPUncW1xHAUuz2CC7QhqYFSk/index.html"

#2022-1-11 超级直播间半点雨ID url cron 30 21,22 * * *
export jd_redrain_half_url="https://gitee.com/msewb/update/raw/master/m_redrain_half_5231120221612.json"

## 互助池
## export JD_CITY_HELPPOOL="false"
